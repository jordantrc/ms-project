...
TEST_FILE_LIST = 'train-test-splits/testlist-random-expanded.txt'
TRAIN_FILE_LIST = 'train-test-splits/trainlist-random-expanded.txt'
...
def iad_nn(run_string):
    ...
    print("train_filenames length after padding" % (len(filenames_train)))
